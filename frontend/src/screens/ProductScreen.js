          ...
          <div className="row top">
            ...
            <div className="col-1">
              <ul>
                ...
                <li>Price : ₹{product.price}<span className="product-small"> /{product.unit} </span></li>
              ...
              <div className="card card-body grey">
                <ul>
                  ...
                  <li>
                    <div className="row">
                      <div>Price Tag :</div>
                      <div className="price">₹{product.priceTag}<span className="product-small"> /{product.unit} </span></div>
                    </div>
                  </li>
                  <li>
                    <div className="row">
                  ...
                  <li>
                    <div className="row">
                      ...
                      <div className="price">{product.minOrder}</div>
                    </div>
                  </li>
